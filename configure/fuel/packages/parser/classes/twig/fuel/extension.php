...
class Twig_Fuel_Extension extends Twig_Extension
{
	...
	public function getFunctions()
	{
		...
		if (class_exists('Twig_SimpleFunction'))
		{
			return array(
                ...
                new Twig_SimpleFunction('asset_cdn_img', array($this, 'cdn_img')),
			    new Twig_SimpleFunction('asset_cdn_img_path', array($this,'cdn_img_path')),
		...
		else
		{
			return array(
                ...
                'asset_cdn_img'           => new Twig_Function_Method($this,'cdn_img'),
			    'asset_cdn_img_path'      => new Twig_Function_Method($this,'cdn_img_path'),
    ...
    public function cdn_img($images = array(), $attr = array(), $group = null)
    {
        $attr['src'] = "https://d1q08lkutgkcx2.cloudfront.net/image/" . $images;
     ...
     * @return string
     */
    public function cdn_img_path($file_path)
    {
        return "https://d1q08lkutgkcx2.cloudfront.net/image/" . $file_path;
    }
