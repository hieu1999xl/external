...
return [
    ...
    'error_mail'               => [
        ...
        'subject' => '【ステージング】【ZEUS】【WEB】システムエラー検知',
    ],
    ...
    'entry_mail'               => [
        ...
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi〉お申し込みありがとうございます',
        'template' => 'mail/entry',
    ],
    ...
    'send_draft_mail' => [
        'from'     => 'noreply@zeus-wifi.jp',
        'subject'  => '【ステージング】〈ZEUS WiFi〉お支払い登録のお願い',
    ...
    'entry_mail_wimax' => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'bcc'      => 'm.taguchi.human@gmail.com',
        'subject'  => '【ステージング】〈ZEUS WiMAX〉お申し込みありがとうございます',
    ...
    'entry_mail_prepaid' => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi CHARGE〉お申し込みありがとうございます',
    ...
    'entry_overseas_mail' => [
        ...
        'to'       => '',
        'bcc'      => [],
        'subject'  => '【ステージング】〈ZEUS WiFi for GLOBAL〉お申し込みありがとうございます',
    ...
    'entry_mail_corp_contact'         => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi〉仮登録完了メール',
    ...
    'entry_settlement_error_mail' => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi〉決済処理に失敗しました',
    ...
    'entry_condo_callback_error_mail' => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi〉お申し込み審査結果のご連絡',
    ...
    'change_condo_callback_error_mail' => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi〉「コンビニ後払い」登録情報の変更ができませんでした',
    ...
    'user_edit_mail'           => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi〉お客様情報変更のお知らせ',
    ...
    'user_payment_edit_mail'   => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi〉お支払い情報変更のお知らせ',
    ...
    'user_payment_condopay_data_edit_mail'   => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi〉「コンビニ後払い」登録情報を変更しました',
    ...
    'user_updated_settlement_notification_mail'   => [
        ...
        'subject'  => '【ステージング】〈〈確認〉〉支払い方法が変更されました',
    ...
    'data_charge_edit_mail'       => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi〉データチャージ完了のお知らせ',
    ...
    'data_charge_edit_mail_prepaid'       => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi CHARGE〉データチャージ完了のお知らせ',
    ...
    'prepaid_option_edit_mail'       => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi CHARGE〉オプションの購入完了のお知らせ',
    ...
    'contract_edit_mail'       => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi〉ご契約内容変更のお知らせ',
    ...
    'contract_option_cancel_mail'       => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi〉オプションの解約を受け付けました',
    ...
    'contract_option_cancel_mail_prepaid'       => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi CHARGE〉オプションの解約を受け付けました',
    ...
    'contract_cancel_mail'     => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi〉解約受付完了のお知らせ',
    ...
    'new_contract_cancel_mail'     => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi〉解約受付完了・端末返却についてのご案内',
    ...
    'contract_cancel_mail_by_wimax'     => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiMAX〉解約受付完了のお知らせ',
    ...
    'contract_cancel_mail_by_prepaid'     => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi CHARGE〉解約受付完了のお知らせ',
    ...
    'initial_contract_cancel_mail'     => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】＜ZEUS WiFi＞申請を受け付けました。',
    ...
    'new_initial_contract_cancel_mail'     => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】＜ZEUS WiFi＞初期契約解除の申請受付完了・端末返却についてのご案内',
    ...
    'initial_contract_cancel_mail_by_wimax'     => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】＜ZEUS WiMAX＞申請を受け付けました。',
    ...
    'password_reminder_mail'   => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi〉パスワード再設定のお知らせ',
    ...
    'loginid_reminder_mail'   => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi〉会員IDのお知らせ',
    ...
    'password_edit_mail'       => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi〉パスワード変更のお知らせ',
    ...
    'entry_mail_corpa'         => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi〉お問い合わせありがとうございます',
     ...
     */
    'entry_mail_corpa_hometown_tax' => [],  // STGは差し替え無し
    ...
    'entry_corpb_support_mail'  => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => 'wifi-corp@humanlife.co.jp',
        'subject'  => '【ステージング】〈ZEUS WiFi〉支払い方法が登録されました',
    ...
    'contact_to_support_mail'  => [
        ...
        'subject'  => '【ステージング】〈ZEUS WiFi〉問い合わせのお知らせ',
    ...
    'contact_to_customer_mail' => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi〉お問い合わせを受け付けました',
    ...
    'contact_to_support_by_wimax_mail'  => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => 'wifi-engineer@humanlife.co.jp',
        'subject'  => '【ステージング】＜ZEUS WiMAX＞問い合わせのお知らせ',
    ...
    'contact_to_customer_by_wimax_mail' => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】＜ZEUS WiMAX＞お問い合わせを受け付けました',
    ...
    'contact_to_support_by_global_mail'  => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => 'wifi-engineer@humanlife.co.jp',
        'subject'  => '【ステージング】＜ZEUS WiFi for GLOBAL＞問い合わせのお知らせ',
    ...
    'contact_to_customer_by_global_mail' => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】＜ZEUS WiFi for GLOBAL＞お問い合わせを受け付けました',
    ...
    'contact_to_support_by_prepaid_mail'  => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => 'wifi-engineer@humanlife.co.jp',
        'subject'  => '【ステージング】〈ZEUS WiFi CHARGE〉問い合わせのお知らせ',
    ...
    'contact_to_customer_by_prepaid_mail' => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi CHARGE〉お問い合わせを受け付けました',
    ...
    'plan_change_cancel_mail'     => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi〉プラン変更キャンセル手続き完了のお知らせ',
    ...
    'plan_change_entry_mail'     => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi〉プラン変更お申込み手続き完了のお知らせ',
    ...
    'atone_cancel_refund_mail'     => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'      => [
            'wifi-engineer@humaninvestment.jp',
        ],
        'subject'  => '【ステージングテスト】〈ZEUS WiFi〉atone決済キャンセル発生のお知らせ',
    ...
    'paysys_webhook_error_mail' => [
        ...
        'subject' => '【ステージング】<ZEUS WiFi>Paysys入金通知失敗のお知らせ',
    ],
    ...
    'paysys_webhook_resume_mail'     => [
        ...
        'subject'  => '【ステージング】<ZEUS WiFi>Paysys入金通知によるユーザーステータス再開のお知らせ',
    ],
    ...
    'entry_insurance' => [
        'from'     => 'noreply@zeus-wifi.jp',
        'subject'  => '【ステージング】〈ZEUS WiFi〉お申込みのデジタルライフサポートについて',
    ...
    'send_bill_mail_datacharge' => [
        ...
        'subject'  => '【ステージング】【重要】〈ZEUS WiFi〉プランご購入のご利用料金お支払いのお願い',
    ...
    'send_bill_mail_option' => [
        'cc'       => [],
        'from'     => 'support@zeus-wifi.jp',
        'subject'  => '【ステージング】【重要】〈ZEUS WiFi〉オプションご購入のご利用料金お支払いのお願い',
    ...
    'exchange_request_to_support_mail'  => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => 'support@zeus-wifi.jp',
        'subject'  => '【ステージング】〈ZEUS WiFi〉端末交換申請のお知らせ',
    ...
    'exchange_request_mail' => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi〉端末交換申請を受け付けました',
    ...
    'entry_cancel_mail_by_international_rental' => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi for GLOBAL〉キャンセル手続き完了のお知らせ',
    ...
    'plan_change_mail_by_international_rental' => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi for GLOBAL〉プラン変更完了のご案内',
    ...
    'plan_extension_mail_by_international_rental' => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi for GLOBAL〉利用期間延長を受付けました',
    ...
    'plan_add_mail_by_international_rental' => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi for GLOBAL〉利用国の追加を受付けました',
    ...
    'gmo_credit_settlement_cancel_failed'     => [
        ...
        'subject'  => '【ステージング】〈ZEUS WiFi for GLOBAL〉申込キャンセル時にGMOクレジットカード決済キャンセル発生のお知らせ',
    ...
    'plan_change_mail_by_international_prepaid' => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi CHARGE〉プラン変更完了のご案内',
    ...
    'plan_extension_mail_by_international_prepaid' => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi CHARGE〉利用期間延長を受付けました',
    ...
    'plan_add_mail_by_international_prepaid' => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi CHARGE〉利用国の追加を受付けました',
    ...
    'giga_charge_edit_mail' => [
        'from'     => 'noreply@zeus-wifi.jp',
        'to'       => '',
        'subject'  => '【ステージング】〈ZEUS WiFi CHARGE〉ギガチャージを受付けました',
    ...
    'failure_disable_prepaid_plan_mail' => [
        'from'     => 'system-alart@zeus-wifi.jp',
        'to'       => 'error_info@googlegroups.com',
        'subject'  => '【ステージング】【重要】〈ZEUS WiFi CHARGE〉プラン変更時に旧プランの無効化に失敗しました。',
    ...
    'failure_disable_rental_plan_mail' => [
        'from'     => 'system-alart@zeus-wifi.jp',
        'to'       => 'error_info@googlegroups.com',
        'subject'  => '【ステージング】【重要】〈ZEUS WiFi for GLOBAL〉プラン変更時に旧プランの無効化に失敗しました。',
    ...
    'webhook_check_charge_mail' => [
        ...
        'subject'  => '【ステージング】〈ZEUS WiFi CHARGE〉ペイディ情報チェックのお願い',
