...
/**
 * 申込・コンビニの中間テーブルのモデルクラス
 *
 * @author ako.endo
 */
class Model_HumanLife_RelEntryConvenience extends Model_CrudAbstract
{
    /**
     * データソース名
     *
     ...
     * @var string
     */
    protected static $_table_name = 'rel_entry_convenience';

    /**
     * プライマリキー
     * @var string カラム名
     */
    protected static $_primary_key = 'entry_convenience_id';
