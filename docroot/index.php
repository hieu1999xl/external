 ...
 */
define('PKGPATH', realpath(__DIR__.'/../configure/fuel/packages/').DIRECTORY_SEPARATOR);

/**
 * The path to the framework core.
 */
define('COREPATH', realpath(__DIR__.'/../configure/fuel/core/').DIRECTORY_SEPARATOR);
...
try {
    ...
    Log::application()->warn($e->getMessage(), array(
    ...
    Log::application()->info('Server : ' .var_export($_SERVER, true));
    Log::application()->info('Cookie : ' .var_export($_COOKIE, true));
    Log::application()->error($e->getMessage(), array(
        'exception' => $e->getTraceAsString()
    ));
    Helper_Mail::send_error_mail('HttpServerErrorException', $e, null);
    ...
    Helper_Mail::send_error_mail('エラー発生', $e, null);
    $response = $routerequest('_500_', $e);
}
