  ...
  $(function() {
    var option = {
      ...
      onfocusout: function(element) {
        ...
        if(elemName === "device_option" || elemName === "plan_per_day" || elemName === "plan_id_tour" || elemName === "_countries" || elemName === "rental_start_date" || elemName === "rental_end_date" || elemName === "prior_delivery_date"){
          return false;
        }
      ...
      highlight: function(element, errorClass) {
        ...
        var elemName = $(element).attr("name");
        if(elemName === "plan_per_day" || elemName === "plan_id_tour" || elemName === "device_option" || elemName === "tie" || elemName === "_countries" || elemName === "rental_start_date" || elemName === "rental_end_date" || elemName === "prior_delivery_date"){
          var speed = 500;
          var target;
